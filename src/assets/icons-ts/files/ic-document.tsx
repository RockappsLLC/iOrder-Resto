...
const IcDocumentIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 40 40" {...props}>
    ...
    <defs>
      ...
      >
        ...
        <feBlend in2="BackgroundImageFix" result="effect1_dropShadow_2550_165181" />
        <feBlend in="SourceGraphic" in2="effect1_dropShadow_2550_165181" result="shape" />
      </filter>
    </defs>
  </svg>
);
export default IcDocumentIcon;
