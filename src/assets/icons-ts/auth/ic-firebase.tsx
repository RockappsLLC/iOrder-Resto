...
const IcFirebaseIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" {...props}>
    <path fill="#FFA000" d="m14.428 8.943-2.201 2.048-2.043-4.12 1.057-2.37c.275-.48.704-.475.972 0l2.215 4.442Z" />
    ...
    />
    <path fill="#FFA000" d="M10.184 6.871 4.001 18.644 6.755 1.438c.101-.536.406-.587.679-.114l2.75 5.547Z" />
  </svg>
);
