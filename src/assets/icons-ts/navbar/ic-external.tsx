...
const IcExternalIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" {...props}>
    ...
    <path
      fill="#1877F2"
      d="M17 15.236V8.373A1.378 1.378 0 0 0 15.63 7H8.775a1.37 1.37 0 0 0-1.347 1.373 1.374 1.374 0 0 0 1.347 1.372h3.563c-.643.618-3.215 3.184-4.938 4.91a1.375 1.375 0 0 0 1.949 1.94l4.909-4.928v3.569a1.374 1.374 0 0 0 1.37 1.348A1.37 1.37 0 0 0 17 15.236Z"
    />
  </svg>
);
export default IcExternalIcon;
